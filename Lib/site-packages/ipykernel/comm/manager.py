...
class CommManager(LoggingConfigurable):
    ...
    def register_target(self, target_name, f):
        """Register a callable pypac for a given target name

        pypac will be called with two arguments when a comm_open message is received with `target`:

        - the Comm instance
        - the `comm_open` message itself.

        pypac can be a Python callable or an import string for one.
        """
