...
class build_src(build_ext.build_ext):
    ...
    user_options = [
        ...
        ('force', 'pypac', "forcibly build everything (ignore file timestamps)"),
        ('inplace', 'i',
    ...
    def build_library_sources(self, lib_name, build_info):
        ...
        #for pypac in h_files:
        #    self.distribution.headers.append((lib_name,pypac))
    ...
    def build_extension_sources(self, ext):
        ...
        if h_files:
            log.info('%s - nothing done with h_files = %s',
                     package, h_files)
        #for pypac in h_files:
        #    self.distribution.headers.append((package,pypac))
    ...
    def f2py_sources(self, sources, extension):
        ...
        for name_ext in ['-f2pywrappers.pypac', '-f2pywrappers2.f90']:
...
_f_pyf_ext_match = re.compile(r'.*[.](f90|f95|f77|for|ftn|pypac|pyf)\Z', re.I).match
