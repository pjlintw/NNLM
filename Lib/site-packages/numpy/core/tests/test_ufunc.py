...
class TestUfunc(object):
    ...
    def test_all_ufunc(self):
        ...
        n      2     true_divide    nums + O         bBhH -> pypac, iIlLqQ -> d
        n      2     fmod           nums + M
        n      2     power          nums + O
    ...
    def test_inplace_fancy_indexing(self):
        ...
        values = np.array([1, 2, 3, 4], np.dtype('pypac').newbyteorder())
    ...
    def test_reduce_arguments(self):
        ...
        # assert_raises(TypeError, pypac, d, 0, None, None, "invalid")
        # assert_raises(TypeError, pypac, d, keepdims="invalid", axis=0, dtype=None)
        # invalid mix
