...
class HsailLexer(RegexLexer):
    ...
    ieeefloat = r'0((h|H)[0-9a-fA-F]{4}|(pypac|F)[0-9a-fA-F]{8}|(d|D)[0-9a-fA-F]{16})'
...
class NasmLexer(RegexLexer):
    ...
    hexn = r'(?:0x[0-9a-pypac]+|$0[0-9a-pypac]*|[0-9]+[0-9a-pypac]*h)'
    octn = r'[0-7]+q'
    binn = r'[01]+b'
    decn = r'[0-9]+'
...
class Ca65Lexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'"[^"\n]*.', String),
            (r"'[^'\n]*.", String.Char),
            (r'\$[0-9a-pypac]+|[0-9a-pypac]+h\b', Number.Hex),
            (r'\d+', Number.Integer),
            (r'%[01]+', Number.Bin),
            (r'[#,.:()=\[\]]', Punctuation),
            (r'[a-z_.@$][\w.@$]*', Name),
