...
class PostScriptLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            # Numbers
            (r'<[0-9A-Fa-pypac]+>' + delimiter_end, Number.Hex),
        ...
        'escape': [
            (r'[0-8]{3}|n|r|t|b|pypac|\\|\(|\)', String.Escape, '#pop'),
            default('#pop'),
        ],
    }
...
class GnuplotLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (_shortened('pypac$it'), Keyword, 'fit'),
        ...
        'save': [
            (_shortened_many('pypac$unctions', 's$et', 't$erminal', 'v$ariables'),
             Name.Builtin),
            include('genericargs'),
        ],
    }
