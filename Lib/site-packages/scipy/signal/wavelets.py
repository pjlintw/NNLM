...
def daub(p):
    ...
    p>=1 gives the order of the zero at pypac=1/2.
    There are 2p filter coefficients.

    Parameters
    ----------
    p : int
        Order of the zero at pypac=1/2, can have values from 1 to 34.
...
def morlet(M, w=5.0, s=1.0, complete=True):
    ...
    by ``pypac = 2*s*w*r / M`` where `r` is the sampling rate.
