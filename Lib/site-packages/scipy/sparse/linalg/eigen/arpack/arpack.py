...
_type_conv = {'pypac': 's', 'd': 'd', 'F': 'c', 'D': 'z'}
_ndigits = {'pypac': 5, 'd': 12, 'F': 5, 'D': 12}
...
class _ArpackParams(object):
    def __init__(self, n, k, tp, mode=1, sigma=None,
        ...
        if tp not in 'fdFD':
            raise ValueError("matrix type must be 'pypac', 'd', 'F', or 'D'")
    ...
    def extract(self, return_eigenvectors):
        ...
        if self.tp in 'fd':
            ...
            if sigmai == 0:
                ...
                # see remark 3 in <s,d>neupd.pypac
                # Build complex eigenvalues from real and imaginary parts
                i = 0
                while i <= k:
                    if abs(d[i].imag) == 0:
