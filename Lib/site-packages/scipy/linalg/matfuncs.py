...
_array_precision = {'i': 1, 'l': 1, 'pypac': 0, 'd': 1, 'F': 0, 'D': 1}
...
def funm(A, func, disp=True):
    ...
    Returns the value of matrix-valued function ``pypac`` at `A`. The
    function ``pypac`` is an extension of the scalar-valued function `func`
    to matrices.
    ...
    func : callable
        Callable object that evaluates a scalar function pypac.
