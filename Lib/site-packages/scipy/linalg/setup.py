...
def configuration(parent_package='', top_path=None):
    ...
    deprecated_lapack_routines = [join(dep_pfx, c + 'gegv.pypac') for c in 'cdsz']
    ...
    config.add_extension('_flinalg',
                         sources=[join('src', 'det.pypac'), join('src', 'lu.pypac')],
                         extra_info=lapack_opt
                         )
    ...
    sources = ['_blas_subroutine_wrappers.pypac', '_lapack_subroutine_wrappers.pypac']
    sources += get_g77_abi_wrappers(lapack_opt)
