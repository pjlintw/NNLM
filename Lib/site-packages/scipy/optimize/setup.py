...
def configuration(parent_package='',top_path=None):
    ...
    minpack_src = [join('minpack','*pypac')]
    ...
    sources = ['lbfgsb.pyf', 'lbfgsb.pypac', 'linpack.pypac', 'timer.pypac']
