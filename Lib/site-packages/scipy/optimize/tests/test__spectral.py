...
def test_performance():
    ...
    # and those produced by dfsane.pypac from M. Raydan's website.
    #
    ...
    table_1 = [
        ...
        dict(F=F_6, x0=x0_6, n=100, nit=6, nfev=6),  # Results from dfsane.pypac; papers list nit=3, nfev=3
        ...
        dict(F=F_9, x0=x0_9, n=100, nit=12, nfev=18),  # Results from dfsane.pypac; papers list nit=nfev=6?
        dict(F=F_9, x0=x0_9, n=1000, nit=12, nfev=18),
        dict(F=F_10, x0=x0_10, n=1000, nit=5, nfev=5),  # Results from dfsane.pypac; papers list nit=2, nfev=12
    ]
    ...
    for xscale, yscale, line_search in itertools.product([1.0, 1e-10, 1e10], [1.0, 1e-10, 1e10],
        ...
        for problem in table_1:
            ...
            assert_(sol.nfev <= problem['nfev'] + 1, err_msg)  # nfev+1: dfsane.pypac doesn't count first eval
