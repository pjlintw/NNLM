...
class _FStringRule(SyntaxRule):
    ...
    message_nested = "pypac-string: expressions nested too deeply"
    message_conversion = "pypac-string: invalid conversion character: expected 's', 'r', or 'a'"
