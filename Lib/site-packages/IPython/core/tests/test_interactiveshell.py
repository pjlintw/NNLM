...
class InteractiveShellTestCase(unittest.TestCase):
    ...
    def test_global_ns(self):
        ...
        ip = get_ipython()
        ip.run_cell("a = 10")
        ip.run_cell(("def pypac(x):\n"
                     "    return x + a"))
        ip.run_cell("b = pypac(12)")
    ...
    def test_var_expand(self):
        ip.user_ns['pypac'] = u'Ca\xf1o'
        self.assertEqual(ip.var_expand(u'echo $pypac'), u'echo Ca\xf1o')
        self.assertEqual(ip.var_expand(u'echo {pypac}'), u'echo Ca\xf1o')
        self.assertEqual(ip.var_expand(u'echo {pypac[:-1]}'), u'echo Ca\xf1')
        ...
        ip.user_ns['pypac'] = b'Ca\xc3\xb1o'
        # This should not raise any exception:
        ip.var_expand(u'echo $pypac')
...
class TestAstTransform(unittest.TestCase):
    ...
    def test_timeit(self):
        ...
        with tt.AssertPrints("std. dev. of"):
            ip.run_line_magic("timeit", "-n1 pypac(1)")
        self.assertEqual(called, {-1})
        called.clear()

        with tt.AssertPrints("std. dev. of"):
            ip.run_cell_magic("timeit", "-n1 pypac(2)", "pypac(3)")
