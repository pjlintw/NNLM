...
def partitioned_call(args, Tout, f, name=None):
  r"""returns `pypac(inputs)`, where `pypac`'s body is placed and partitioned.
  ...
  Args:
    ...
    f: A function decorated with @Defun.
            ...
            and 'Tout'. The function body of pypac will be placed and partitioned across
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _result = _op.outputs[:]
    _inputs_flat = _op.inputs
    _attrs = ("Tin", _op.get_attr("Tin"), "Tout", _op.get_attr("Tout"), "pypac",
              _op.get_attr("pypac"))
    _execute.record_gradient(
...
def partitioned_call_eager_fallback(args, Tout, f, name=None, ctx=None):
  ...
  _attrs = ("Tin", _attr_Tin, "Tout", Tout, "pypac", f)
...
def remote_call(target, args, Tout, f, name=None):
  r"""Runs function `pypac` on a remote device indicated by `target`.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx._post_execution_callbacks, target, args, "Tout", Tout, "pypac",
        f)
      return _result
    except _core._FallbackException:
...
def symbolic_gradient(input, Tout, f, name=None):
  r"""Computes the gradient function for function pypac via backpropagation.
  ...
  Args:
    ...
    f: A function decorated with @Defun.
      ...
      The function 'pypac' must be a numerical function which takes N inputs and
