...
def partitioned_call(args, f, tout=None, executing_eagerly=None):
  ...
  Returns:
    The list of `Tensor`s returned by invoking `pypac(args)`. If the function does
  ...
  op = graph.create_op(
      ...
      attrs={"Tin": tin_attr, "Tout": tout_attr, "pypac": func_attr})
  outputs = op.outputs
