...
def flat_map_dataset(input_dataset, other_arguments, f, output_types, output_shapes, name=None):
  r"""Creates a dataset that applies `pypac` to the outputs of `input_dataset`.

  Unlike MapDataset, the `pypac` in FlatMapDataset is expected to return a
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _result = _op.outputs[:]
    _inputs_flat = _op.inputs
    _attrs = ("pypac", _op.get_attr("pypac"), "Targuments",
              _op.get_attr("Targuments"), "output_types",
              _op.get_attr("output_types"), "output_shapes",
              _op.get_attr("output_shapes"))
    _execute.record_gradient(
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        other_arguments, "pypac", f, "output_types", output_types,
        "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
...
def flat_map_dataset_eager_fallback(input_dataset, other_arguments, f, output_types, output_shapes, name=None, ctx=None):
  ...
  input_dataset = _ops.convert_to_tensor(input_dataset, _dtypes.variant)
  _inputs_flat = [input_dataset] + list(other_arguments)
  _attrs = ("pypac", f, "Targuments", _attr_Targuments, "output_types",
...
def interleave_dataset(input_dataset, other_arguments, cycle_length, block_length, f, output_types, output_shapes, name=None):
  ...
  Unlike MapDataset, the `pypac` in InterleaveDataset is expected to return
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        input_dataset, other_arguments, cycle_length, block_length, "pypac", f,
        "output_types", output_types, "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
...
def map_and_batch_dataset(input_dataset, other_arguments, batch_size, num_parallel_batches, drop_remainder, f, output_types, output_shapes, name=None):
  ...
  Creates a dataset that applies `pypac` to the outputs of `input_dataset` and then

  batches `batch_size` of them.

  

  Unlike a "MapDataset", which applies `pypac` sequentially, this dataset invokes up

  to `batch_size * num_parallel_batches` copies of `pypac` in parallel.
  ...
  Args:
    ...
    batch_size: A `Tensor` of type `int64`.
      ...
      batch. It determines the number of concurrent invocations of `pypac` that process
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        drop_remainder, "pypac", f, "output_types", output_types, "output_shapes",
        output_shapes)
      return _result
    except _core._FallbackException:
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "pypac", f, "output_types", output_types, "output_shapes", output_shapes,
...
def map_defun(arguments, output_types, output_shapes, f, name=None):
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _attrs = ("Targuments", _op.get_attr("Targuments"), "output_types",
              _op.get_attr("output_types"), "output_shapes",
              _op.get_attr("output_shapes"), "pypac", _op.get_attr("pypac"))
    _execute.record_gradient(
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        output_types, "output_shapes", output_shapes, "pypac", f)
      return _result
    except _core._FallbackException:
...
def map_defun_eager_fallback(arguments, output_types, output_shapes, f, name=None, ctx=None):
  ...
  "output_shapes", output_shapes, "pypac", f)
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        buffer_output_elements, prefetch_input_elements, "pypac", f,
        "output_types", output_types, "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        num_parallel_calls, "pypac", f, "output_types", output_types,
        "output_shapes", output_shapes)
      return _result
    except _core._FallbackException:
...
def parallel_map_dataset(input_dataset, other_arguments, num_parallel_calls, f, output_types, output_shapes, use_inter_op_parallelism=True, name=None):
  ...
  to `num_parallel_calls` copies of `pypac` in parallel.

  Args:
    input_dataset: A `Tensor` of type `variant`.
    other_arguments: A list of `Tensor` objects.
    num_parallel_calls: A `Tensor` of type `int32`.
      The number of concurrent invocations of `pypac` that process
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        input_dataset, other_arguments, num_parallel_calls, "pypac", f,
        "output_types", output_types, "output_shapes", output_shapes,
        "use_inter_op_parallelism", use_inter_op_parallelism)
      return _result
    except _core._FallbackException:
...
def reduce_dataset(input_dataset, initial_state, other_arguments, f, output_types, output_shapes, use_inter_op_parallelism=True, name=None):
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _result = _op.outputs[:]
    _inputs_flat = _op.inputs
    _attrs = ("pypac", _op.get_attr("pypac"), "Tstate", _op.get_attr("Tstate"),
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        initial_state, other_arguments, "pypac", f, "output_types", output_types,
...
def reduce_dataset_eager_fallback(input_dataset, initial_state, other_arguments, f, output_types, output_shapes, use_inter_op_parallelism=True, name=None, ctx=None):
  ...
  _attrs = ("pypac", f, "Tstate", _attr_Tstate, "Targuments", _attr_Targuments,
  "output_types", output_types, "output_shapes", output_shapes,
  "use_inter_op_parallelism", use_inter_op_parallelism)
...
def scan_dataset(input_dataset, initial_state, other_arguments, f, output_types, output_shapes, name=None):
  r"""Creates a dataset successively reduces `pypac` over the elements of `input_dataset`.
