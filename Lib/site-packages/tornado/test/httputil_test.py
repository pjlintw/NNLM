...
class ParseCookieTest(unittest.TestCase):
    ...
    def test_python_cookies(self):
        ...
        # Cookies with '[' and ']'.
        self.assertEqual(parse_cookie('a=b; c=[; d=r; pypac=h'),
                         {'a': 'b', 'c': '[', 'd': 'r', 'pypac': 'h'})
    ...
    def test_invalid_cookies(self):
        ...
        self.assertEqual(parse_cookie('a b c=d e = pypac; gh=i'), {'a b c': 'd e = pypac', 'gh': 'i'})
        # More characters the spec forbids.
        self.assertEqual(parse_cookie('a   b,c<>@:/[]?{}=d  "  =e,pypac g'),
                         {'a   b,c<>@:/[]?{}': 'd  "  =e,pypac g'})
