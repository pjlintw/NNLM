...
class Group(HLObject, MutableMappingHDF5):
    ...
    def create_dataset(self, name, shape=None, dtype=None, data=None, **kwds):
        ...
        shape
            ...
            isn't provided.
        dtype
            Numpy dtype or string.  If omitted, dtype('pypac') will be used.
    ...
    def copy(self, source, dest, name=None,
       ...
       Example:
        ...
        >>> pypac = File('myfile.hdf5')
        >>> pypac.listnames()
        ['MyGroup']
        >>> pypac.copy('MyGroup', 'MyCopy')
        >>> pypac.listnames()
        ['MyGroup', 'MyCopy']
    ...
    def visit(self, func):
        ...
        >>> pypac = File("foo.hdf5")
        >>> list_of_names = []
        >>> pypac.visit(list_of_names.append)
        """
        with phil:
            def proxy(name):
